                        ...
                        ((Some "simple"), None,
                         [ ([ Gram.Skeyword "module"; Gram.Skeyword "type";
                           ...
                           ([ Gram.Skeyword "(";
                              ...
                              Gram.Skeyword ")" ],
                            (Gram.Action.mk
                               (fun _ (i : 'e__1) _ (_loc : Gram.Loc.t) ->
                           ...
                           ([ Gram.Snterm
                                (Gram.Entry.obj
                                   (test_module_longident_dot_delim :
                                     'test_module_longident_dot_delim Gram.
                                       Entry.t));
                              Gram.Snterm
                                (Gram.Entry.obj
                                   (module_longident :
                              ...
                              Gram.Skeyword "."; Gram.Sself ],
                            (Gram.Action.mk
                               (fun (e : 'expr) _ (m : 'module_longident) _
                                  (_loc : Gram.Loc.t) ->
                                  (Ast.ExOpI (_loc, m, Ast.OvNil, e) : 'expr))));
                           ([ Gram.Snterm
                                (Gram.Entry.obj
                                   ...
                                   [ ([ Gram.Snterm
                                      ...
                                      (Gram.Action.mk
                                         (fun _ (sg : 'sig_item)
                                            ...
                                            (sg : 'e__14)))) ]) ],
                            (Gram.Action.mk
                               (fun (l : 'e__14 list) (_loc : Gram.Loc.t) ->
                                   ...
                                   [ ([ Gram.Snterm
                                      ...
                                      (Gram.Action.mk
                                         (fun _ (st : 'str_item)
                                            ...
                                            (st : 'e__15)))) ]) ],
                            (Gram.Action.mk
                               (fun (l : 'e__15 list) (_loc : Gram.Loc.t) ->
                            ...
                            Gram.Sopt
                              (Gram.srules stream_patt_comp
                                 [ ([ Gram.Skeyword "when";
                                    ...
                                    (Gram.Action.mk
                                       (fun (e : 'stream_expr) _
                                          (_loc : Gram.Loc.t) -> (e : 'e__17)))) ]) ],
                          (Gram.Action.mk
                             (fun (eo : 'e__17 option) (p : 'patt) _
                                (_loc : Gram.Loc.t) ->
                       ...
                       [ ([ Gram.Sopt
                          ...
                          (Gram.Action.mk
                             (fun (rules : 'rule_list) (ass : 'assoc option)
                                (lab : 'e__21 option) (_loc : Gram.Loc.t) ->
                                 ...
                                 [ ([ Gram.Stoken
                                    ...
                                    (Gram.Action.mk
                                       (fun (s : Gram.Token.t)
                                          ...
                                          | _ -> assert false))) ]) ],
                          (Gram.Action.mk
                             (fun (lev : 'e__22 option) (i : Gram.Token.t)
                                (_loc : Gram.Loc.t) ->
                                 ...
                                 [ ([ Gram.Stoken
                                    ...
                                    (Gram.Action.mk
                                       (fun (s : Gram.Token.t)
                                          ...
                                          | _ -> assert false))) ]) ],
                          (Gram.Action.mk
                             (fun (lev : 'e__25 option) (il : 'qualid) _
                                    ...
                                    (Gram.Action.mk
                                       (fun _ (d : 'macro_def)
                                          ...
                                          (execute_macro_if_active_branch
                                            ...
                                            'e__27)))) ]) ],
                          (Gram.Action.mk
                             (fun (sml : 'e__27 list) (_loc : Gram.Loc.t) ->
                                (sml : 'smlist_then)))) ]) ]))
                  ());
                                    ...
                                    (Gram.Action.mk
                                       (fun _ (d : 'macro_def)
                                          ...
                                          (execute_macro_if_active_branch
                                            ...
                                            'e__28)))) ]) ],
                          (Gram.Action.mk
                             (fun (sml : 'e__28 list) (_loc : Gram.Loc.t) ->
                                (sml : 'smlist_else)))) ]) ]))
                  ());
                                    ...
                                    (Gram.Action.mk
                                       (fun _ (d : 'macro_def_sig)
                                          ...
                                          (execute_macro_if_active_branch
                                            ...
                                            'e__29)))) ]) ],
                          (Gram.Action.mk
                             (fun (sgl : 'e__29 list) (_loc : Gram.Loc.t) ->
                                (sgl : 'sglist_then)))) ]) ]))
                  ());
                                    ...
                                    (Gram.Action.mk
                                       (fun _ (d : 'macro_def_sig)
                                          ...
                                          (execute_macro_if_active_branch
                                            ...
                                            'e__30)))) ]) ],
                          (Gram.Action.mk
                             (fun (sgl : 'e__30 list) (_loc : Gram.Loc.t) ->
                                (sgl : 'sglist_else)))) ]) ]))
                  ());
                       ...
                       [ ([],
                         ...
                         ([ Gram.Skeyword "(";
                            ...
                            Gram.Snterm
                              (Gram.Entry.obj (expr : 'expr Gram.Entry.t)) ],
                          (Gram.Action.mk
                             (fun (e : 'expr) _ _ (pl : 'e__31 list) _
                                (_loc : Gram.Loc.t) ->
                            ...
                            Gram.srules expr
                              [ ([ Gram.Skeyword "IN" ],
                                 (Gram.Action.mk
                                    (fun (x : Gram.Token.t)
                                       (_loc : Gram.Loc.t) ->
                                       (Gram.Token.extract_string x : 'e__32))));
                                ([ Gram.Skeyword "DEFINE" ],
                                 (Gram.Action.mk
                                    (fun (x : Gram.Token.t)
                                       (_loc : Gram.Loc.t) ->
                                ...
                                ([ Gram.Skeyword "IFDEF" ],
                                 (Gram.Action.mk
                                    (fun (x : Gram.Token.t)
                                       ...
                                       (Gram.Token.extract_string x : 'e__32)))) ] ],
                          (Gram.Action.mk
                             (fun (kwd : 'e__32) _ (_loc : Gram.Loc.t) ->
                            ...
                            Gram.srules patt
                              [ ([ Gram.Skeyword "ENDIF" ],
                                 (Gram.Action.mk
                                    (fun (x : Gram.Token.t)
                                       (_loc : Gram.Loc.t) ->
                                       (Gram.Token.extract_string x : 'e__33))));
                                ([ Gram.Skeyword "END" ],
                                 (Gram.Action.mk
                                    (fun (x : Gram.Token.t)
                                       (_loc : Gram.Loc.t) ->
                                ...
                                ([ Gram.Skeyword "IFDEF" ],
                                 (Gram.Action.mk
                                    (fun (x : Gram.Token.t)
                                       ...
                                       (Gram.Token.extract_string x : 'e__33)))) ] ],
                          (Gram.Action.mk
                             (fun (kwd : 'e__33) _ (_loc : Gram.Loc.t) ->
