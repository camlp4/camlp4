                       ...
                       [ ([ Gram.Sopt
                          ...
                          (Gram.Action.mk
                             (fun (rules : 'rule_list) (ass : 'assoc option)
                                (lab : 'e__20 option) (_loc : Gram.Loc.t) ->
                                 ...
                                 [ ([ Gram.Stoken
                                    ...
                                    (Gram.Action.mk
                                       (fun (s : Gram.Token.t)
                                          ...
                                          | _ -> assert false))) ]) ],
                          (Gram.Action.mk
                             (fun (lev : 'e__21 option) (i : Gram.Token.t)
                                (_loc : Gram.Loc.t) ->
                                 ...
                                 [ ([ Gram.Stoken
                                    ...
                                    (Gram.Action.mk
                                       (fun (s : Gram.Token.t)
                                          ...
                                          | _ -> assert false))) ]) ],
                          (Gram.Action.mk
                             (fun (lev : 'e__24 option) (il : 'qualid) _
                       ...
                       [ ([],
                         ...
                         ([ Gram.Skeyword "(";
                            ...
                            Gram.Snterm
                              (Gram.Entry.obj (expr : 'expr Gram.Entry.t)) ],
                          (Gram.Action.mk
                             (fun (e : 'expr) _ _ (pl : 'e__30 list) _
                                (_loc : Gram.Loc.t) ->
